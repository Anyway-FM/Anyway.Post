...
<head>
	...
	<link rel="stylesheet" rev="stylesheet" href="http://anyway-web.b0.upaiyun.com/anyway.post/main.css" type="text/css" media="all" />
...
<body>
	<header class="responsive">
		<img class="logo" src="http://anyway-web.b0.upaiyun.com/anyway.post/anyway-post-logo.svg" alt="Anyway.Post 安妮薇邮报" />		
	</header>
